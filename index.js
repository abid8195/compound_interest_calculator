...
// This is a Compound interest calculator that prompts a user for some inputs, and finally calculates the compounded interest value
...
// step 1 - defined a function that can be used to calculate the final value of the compounded interest
...
// step 2 - defined a function that would calculate the difference (ie the effect that compounding has had)
...
// step 3 - created a run function that then prompts the user for all necessary inputs required to calculate the final amounts
...
// step 4 - inside of said function, made a pretty print statement using a template literal string that gives the financial breakdown
